...
-- -----------------------------------------------------
-- Table `opensms`.`category_has_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `opensms`.`category_has_item` (
  `category` INT(11) NOT NULL,
  `item` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`category`, `item`),
  INDEX `fk_category_has_item_item1_idx` (`item` ASC),
  INDEX `fk_category_has_item_category1_idx` (`category` ASC),
...
CREATE TABLE IF NOT EXISTS `opensms`.`grn_order` (
  `grn_order_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `opensms`.`batch` (
  `batch_code` VARBINARY(16) NOT NULL,
  `item` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `opensms`.`iis_order` (
  `iis_order_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `item_issuer_employee` INT(10) UNSIGNED NOT NULL,
  `return_check_employee` INT(10) UNSIGNED NULL COMMENT 'accepts end of the day returns',
...
CREATE TABLE IF NOT EXISTS `opensms`.`pre_order_has_item` (
  `item` VARCHAR(100) NOT NULL,
  `pre_order` BIGINT UNSIGNED NOT NULL,
  `quantity` DECIMAL(15,3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `opensms`.`iis_order_has_batch` (
  `iis_order` BIGINT UNSIGNED NOT NULL,
  `batch` VARBINARY(16) NOT NULL,
  `issued_quantity` DECIMAL(15,3) NOT NULL,
  `return_quantity` DECIMAL(15,3) NULL,
...
CREATE TABLE IF NOT EXISTS `opensms`.`gsr_order` (
  `gsr_order_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `customer` INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `opensms`.`iis_order_batch_has_gsr_order` (
  `iis_order` BIGINT UNSIGNED NOT NULL,
  `batch` VARBINARY(16) NOT NULL,
  `gsr_order` BIGINT UNSIGNED NOT NULL,
  `quantity` DECIMAL(15,3) NOT NULL,
  PRIMARY KEY (`iis_order`, `batch`, `gsr_order`),
  INDEX `fk_iis_order_has_batch_has_gsr_order_gsr_order1_idx` (`gsr_order` ASC),
  INDEX `fk_iis_order_has_batch_has_gsr_order_iis_order_has_batch1_idx` (`iis_order` ASC, `batch` ASC),
  CONSTRAINT `fk_iis_order_has_batch_has_gsr_order_iis_order_has_batch1`
...
CREATE TABLE IF NOT EXISTS `opensms`.`gsr_payment` (
  `gsr_payment_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `payment_method` INT UNSIGNED NOT NULL,
  `cashier_employee` INT(10) UNSIGNED NOT NULL,
  `gsr_order` BIGINT UNSIGNED NOT NULL,
  `amount` DECIMAL(20,2) NOT NULL,
